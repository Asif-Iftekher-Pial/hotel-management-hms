    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="review-add">
                    ...
                    <form id="reviewForm" class="ra-form" method="POST">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" id="this_customer_id" name="customer_id" value="{{ Auth::guard('customer')->user()->id }}">
                            <div class="col-lg-12">
                                <div>
                                    <h5>You Rating:</h5>
                                    <div class="rating d-flex">
                                        ...
                                        <div style="width: 50px;">
                                            <input type="radio" class="small-size" name="star" value="1"
                                                style="height:20px" id="" checked>
                                        </div>
                                        <i class="icon_star"></i>
                                        <div style="width: 50px;">
                                            <input type="radio" class="small-size" name="star" value="2"
                                                style="height:20px" id="">
                                        </div>
                                        <i class="icon_star"></i>
                                        <div style="width: 50px;">
                                            <input type="radio" class="small-size" name="star" value="3"
                                                style="height:20px" id="">
                                        </div>
                                        <i class="icon_star"></i>
                                        <div style="width: 50px;">
                                            <input type="radio" class="small-size" name="star" value="4"
                                                style="height:20px" id="">
                                        </div>
                                        <i class="icon_star"></i>
                                        <div style="width: 50px;">
                                            <input type="radio" class="small-size" name="star" value="5"
                                                style="height:20px" id="">
                                        </div>
                                    </div>
                                </div>
                ...
                @else
                    <p>What to add your review? <a class="customColor h5" style="background-color: #0000003b;" href="{{ route('front.login') }}">Click here..</a></p>
                @endif
